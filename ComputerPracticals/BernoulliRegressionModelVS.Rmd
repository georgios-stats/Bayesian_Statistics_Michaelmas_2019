...
Write the RJAGS program implementing the hierarchical model above, in order a sample of size $N=100000$ from the posterior distribution  $$(\mathscr{M}^{(j)},p^{(j)})\sim\pi(\mathscr{M},p|y_{1:n})\  ,\  \  j=1,...,N.$$
...
Calculate the posterior marginal model model probabilities

$$
\Pi(\text{Model-I}|y_{1:n})=
\Pi(\mathscr{M}=(0,0)|y_{1:n})
$$

$$
\Pi(\text{Model-II}|y_{1:n})=
\Pi(\mathscr{M}=(1,0)|y_{1:n})
$$

$$
\Pi(\text{Model-III}|y_{1:n})=
\Pi(\mathscr{M}=(0,1)|y_{1:n})
$$
$$
\Pi(\text{Model-IV}|y_{1:n})=
\Pi(\mathscr{M}=(1,1)|y_{1:n})
$$
...
pr_1 = mean(as.numeric(ind.smpl[1,,]==0) * as.numeric(ind.smpl[2,,]==0))
pr_2 = mean(as.numeric(ind.smpl[1,,]==1) * as.numeric(ind.smpl[2,,]==0))
pr_3 = mean(as.numeric(ind.smpl[1,,]==0) * as.numeric(ind.smpl[2,,]==1))
pr_4 = mean(as.numeric(ind.smpl[1,,]==1) * as.numeric(ind.smpl[2,,]==1))
pr_1234 = pr_1+pr_2+pr_3+pr_4
