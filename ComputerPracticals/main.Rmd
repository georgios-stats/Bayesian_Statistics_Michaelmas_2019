...
+ [Monte Carlo approximation: An intoduction  for practical use in R](./MCapproximators.nb.html)  

+ Case study: Space shuttle Challenger disaster  

  + [Bernoulli model with conjugate priors](./BernoulliModel.nb.html)

  + [Bernoulli regression model](./BernouliRegressionModel.nb.html)  
  
  + [Bernoulli regression model -variable selection](./BernouliRegressionModelVS.nb.html)  
  
+ Exercises for pracise:  

  + [Normal model](./NormalModel.nb.html) 
