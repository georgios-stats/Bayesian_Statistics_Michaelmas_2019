...
sliderInput("Bern2_w1",
                 "$$\\varpi_1:$$",
                  ...
                  step = 0.01,
                  value = 0.25)
sliderInput("Bern2_tau10",
                 "$$\\tau_{1,0}:$$",
                  min = 0.00,
                  max = 70,
                  step = 0.05,
                  value = 27)
sliderInput("Bern2_tau11",
                 "$$\\tau_{1,1}:$$",
                  min = 0.00,
                  max = 35.0,
                  step = 0.05,
                  value = 17)
sliderInput("Bern2_tau20",
                 "$$\\tau_{2,0}:$$",
                  min = 0.00,
                  max = 70.0,
                  step = 0.05,
                  value = 26)
sliderInput("Bern2_tau21",
                 "$$\\tau_{2,1}:$$",
                  min = 0.00,
                  max = 35.0,
                  step = 0.05,
...
renderPlot({
   plot_Bernoulli2_param(theta=input$Bern2_theta, 
                  n=input$Bern2_n, 
                  w1=input$Bern2_w1, 
                  tau_10=input$Bern2_tau10, 
                  tau_11=input$Bern2_tau11, 
                  tau_20=input$Bern2_tau20, 
                  tau_21=input$Bern2_tau21
                  )
  })
```
